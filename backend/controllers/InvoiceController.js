...
const createInvoiceJSON = (prescription) => {
  const invoice = {
    shipping: {
      name:
        prescription.appointmentId.patientId.userId.firstName +
        " " +
        prescription.appointmentId.patientId.userId.lastName,
...
async function getInvoice(req, res) {
  ...
  res.setHeader(
    "Content-Disposition",
    `attachment; filename=medical_invoice_${prescriptionId}.pdf`
  );
