...
const DoctorsSlider = forwardRef(
  ({ doctors }, { navigationNextRef, navigationPrevRef }) => {
    return (
      <CustomSwiper
        spaceBetween={60}
            ...
            <SwiperSlide key={doctor._id}>
              <DoctorCard>
                ...
                <DoctorCardBottom>
                  ...
                  <DoctorPrice>{doctor.email}</DoctorPrice>
                  <DoctorDescription>
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                    Labore molestias, quis iste inventore nobis itaque!
                  </DoctorDescription>
                </DoctorCardBottom>
              </DoctorCard>
            </SwiperSlide>
